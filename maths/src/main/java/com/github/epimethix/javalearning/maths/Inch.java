...
public final class Inch {
	private static final double ONE_INCH_IN_MILLIMETERS = 25.4d;

	public static double millimeterToInch(double mm) {
		return mm / ONE_INCH_IN_MILLIMETERS;
	}

	public static double inchToMillimeter(double in) {
		return ONE_INCH_IN_MILLIMETERS * in;
	}
